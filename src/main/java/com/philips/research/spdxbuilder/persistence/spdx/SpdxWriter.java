...
public class SpdxWriter implements BillOfMaterialsStore {
    ...
    private void writeDocumentInformation(TagValueDocument doc, String name) throws IOException {
        ...
        doc.addValue("CreatorComment", "This SPDX file was automatically generated by " + application + ".");
        doc.addValue("DocumentComment", "This document was automatically generated.");
